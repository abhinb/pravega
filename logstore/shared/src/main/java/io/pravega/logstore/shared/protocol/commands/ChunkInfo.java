...
public class ChunkInfo extends AbstractCommand implements Reply {
    final CommandType type = CommandType.CHUNK_INFO;
    ...
    public static AbstractCommand readFrom(DataInput in, int length) throws IOException {
        ...
        long chunkLength = in.readLong();
        return new ChunkInfo(requestId, chunkId, entryCount, chunkLength);
    }
}
