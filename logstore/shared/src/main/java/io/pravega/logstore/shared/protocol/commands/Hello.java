...
public final class Hello extends AbstractCommand implements Request, Reply {
    final CommandType type = CommandType.HELLO;
    final int highVersion;
    final int lowVersion;

    @Override
    public void process(RequestProcessor rp) {
        rp.hello(this);
    }
