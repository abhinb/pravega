...
public final class KeepAlive extends AbstractCommand implements Request, Reply {
    final CommandType type = CommandType.KEEP_ALIVE;
    ...
    public static AbstractCommand readFrom(DataInput in, int length) {
