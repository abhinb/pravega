...
public class ChunkAlreadyExists extends AbstractCommand implements Reply {
    final CommandType type = CommandType.CHUNK_ALREADY_EXISTS;
    final long requestId;
    final long chunkId;

    @Override
    public void process(ReplyProcessor cp) {
        cp.chunkAlreadyExists(this);
    }
    ...
    public static AbstractCommand readFrom(DataInput in, int length) throws IOException {
        ...
        return new ChunkAlreadyExists(requestId, chunkId);
    }
}
