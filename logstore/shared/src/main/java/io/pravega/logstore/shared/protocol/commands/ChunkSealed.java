...
public class ChunkSealed extends AbstractCommand implements Reply {
    final CommandType type = CommandType.CHUNK_SEALED;
    ...
    public static AbstractCommand readFrom(DataInput in, int length) throws IOException {
        ...
        return new ChunkSealed(requestId, chunkId);
    }
}