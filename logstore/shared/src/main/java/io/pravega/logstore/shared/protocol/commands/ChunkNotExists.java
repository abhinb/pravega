...
public class ChunkNotExists extends AbstractCommand implements Reply {
    final CommandType type = CommandType.CHUNK_NOT_EXISTS;
    final long requestId;
    final long chunkId;

    @Override
    public void process(ReplyProcessor cp) {
        cp.chunkNotExists(this);
    }
    ...
    public static AbstractCommand readFrom(DataInput in, int length) throws IOException {
        ...
        return new ChunkNotExists(requestId, chunkId);
    }
}
