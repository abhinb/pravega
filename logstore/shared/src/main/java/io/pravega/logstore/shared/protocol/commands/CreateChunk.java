...
public class CreateChunk extends AbstractCommand implements Request {
    final CommandType type = CommandType.CREATE_CHUNK;
    ...
    public static AbstractCommand readFrom(DataInput in, int length) throws IOException {
        ...
        return new CreateChunk(requestId, chunkId);
    }
}
