...
public class TrackedConnection implements AutoCloseable {
    ...
    /**
     * Updates the total outstanding byte count for this connection and pauses ({@link Connection#pauseReading})
    ...
    /**
     * See {@link Connection#send(AbstractCommand)}.
     *
     * @param cmd The {@link AbstractCommand} to send.
     */
    void send(AbstractCommand cmd) {
