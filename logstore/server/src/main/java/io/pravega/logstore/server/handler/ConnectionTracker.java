...
public class ConnectionTracker {
    ...
    /**
     * Updates the total outstanding byte count for the given connection and pauses ({@link Connection#pauseReading})
     * or resumes ({@link Connection#resumeReading} as needed.
     *
     * @param connection                 The {@link Connection} to pause or resume if needed.
     ...
     */
    void updateOutstandingBytes(Connection connection, long deltaBytes, long connectionOutstandingBytes) {
